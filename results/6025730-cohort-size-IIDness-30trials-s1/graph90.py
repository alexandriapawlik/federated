...
plt.savefig('results/' + batch_name + '/' + str(batch) + '.rounds_vs_cohortsize_90.png')
...
plt.suptitle('Batch 6025730: ' + str(trials) + ' Trials', size=20)
plt.savefig('results/' + batch_name + '/' + str(batch) + '.rounds_vs_cohortsize_90stdev.png')
...
plt.suptitle('Batch 6025730: ' + str(trials) + ' Trials', size=20)
plt.savefig('results/' + batch_name + '/' + str(batch) + '.rounds_vs_cohortsize_90maxmin.png')
...
plt.suptitle('Batch 6025730: ' + str(trials) + ' Trials', size=20)
plt.savefig('results/' + batch_name + '/' + str(batch) + '.rounds_vs_cohortsize_90reg.png')