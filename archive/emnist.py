...
random.shuffle(emnist_train.client_ids)
...
for round_num in range(1, NUM_ROUNDS + 1):
	...
	if end > start:
		...
		sample_clients = emnist_train.client_ids[start:len(emnist_train.client_ids)]
		sample_clients.extend(emnist_train.client_ids[0:end])
